...
public class TaskTest extends TestCase
{
    ...
    public void testUserInfo() {
        ...
        CommandDispatcher dispatcher = new CommandDispatcher();
        // 模拟用户输入 deploy 命令
        String[] args = new String[]{"command", "-i", "inventory.yaml", "web_master", "-y", "-e", "date"};
        // String[] args = parseArgs("");
    ...
    public void testFecthTask() {
        ...
        CommandDispatcher dispatcher = new CommandDispatcher();
        // 模拟用户输入 deploy 命令
        String[] args = new String[]{"fetch", "-i", "inventory.yaml", "web_master", "-y", "-f", "/app/web/taskssh-1.2.1.jar", "-F", "-d", "./download/${service_path}"};
        // String[] args = parseArgs("");
